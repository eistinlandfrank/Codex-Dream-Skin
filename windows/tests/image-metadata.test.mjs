...
const featured = await fs.readFile(path.join(windowsRoot, "assets", "toki-reference.png"));
...
const cli = spawnSync(process.execPath, [helper, "--check", path.join(windowsRoot, "assets", "toki-reference.png")], {
  encoding: "utf8",
});
...
const malformedPng = Buffer.from(featured.subarray(0, 24));
malformedPng[0] = 0;
